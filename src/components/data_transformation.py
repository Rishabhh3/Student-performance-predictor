...
class DataTransformation:
    ...
    def get_data_tranformer_object(self): # to create pkl file and to convert categorical data into numerical data, standard scaler etc
        '''
    ...
    def initiate_data_transform(self,train_path,test_path): # we are getting this from data ingestion
